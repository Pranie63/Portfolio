...
const projectMappings: Map<String, Array<ProjectProps>> = new Map<String, Array<ProjectProps>>(
    ...
    ["Cybersecurity", [{name: "Blockchain", link: "https://github.com/Pranie63/PranavPenny", imgPath: BlockchainPic}]], 
    ["Robotics", [{name: "Racing Algorithms", link: "https://github.com/Pranie63/Racing-Algorithms/", imgPath: RacingAlgoPic}]]]);
